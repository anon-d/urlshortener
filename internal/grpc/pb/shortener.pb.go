...
const file_shortener_proto_rawDesc = "" +
	"\n" +
	"\x0fshortener.proto\x12\furlshortener\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\x03url\x18\x01 \x03(\v2\x15.urlshortener.URLDataR\x03url\"I\n" +
	"\aURLData\x12\x1b\n" +
	...
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a\x1e.urlshortener.UserURLsResponseB4Z2github.com/anon-d/urlshortener/internal/grpc/pb;pbb\x06proto3"
...
var file_shortener_proto_goTypes = []any{
	(*URLShortenRequest)(nil),  // 0: urlshortener.URLShortenRequest
	(*URLShortenResponse)(nil), // 1: urlshortener.URLShortenResponse
	(*URLExpandRequest)(nil),   // 2: urlshortener.URLExpandRequest
	(*URLExpandResponse)(nil),  // 3: urlshortener.URLExpandResponse
	(*UserURLsResponse)(nil),   // 4: urlshortener.UserURLsResponse
	(*URLData)(nil),            // 5: urlshortener.URLData
	(*emptypb.Empty)(nil),      // 6: google.protobuf.Empty
}
var file_shortener_proto_depIdxs = []int32{
	5, // 0: urlshortener.UserURLsResponse.url:type_name -> urlshortener.URLData
	0, // 1: urlshortener.ShortenerService.ShortenURL:input_type -> urlshortener.URLShortenRequest
	2, // 2: urlshortener.ShortenerService.ExpandURL:input_type -> urlshortener.URLExpandRequest
	6, // 3: urlshortener.ShortenerService.ListUserURLs:input_type -> google.protobuf.Empty
	1, // 4: urlshortener.ShortenerService.ShortenURL:output_type -> urlshortener.URLShortenResponse
	3, // 5: urlshortener.ShortenerService.ExpandURL:output_type -> urlshortener.URLExpandResponse
	4, // 6: urlshortener.ShortenerService.ListUserURLs:output_type -> urlshortener.UserURLsResponse
