...
const (
	ShortenerService_ShortenURL_FullMethodName   = "/urlshortener.ShortenerService/ShortenURL"
	ShortenerService_ExpandURL_FullMethodName    = "/urlshortener.ShortenerService/ExpandURL"
	ShortenerService_ListUserURLs_FullMethodName = "/urlshortener.ShortenerService/ListUserURLs"
)
